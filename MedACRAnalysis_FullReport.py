...
#        ReportFile.write( '\t\tVertical CoV (%):   %-12s\n' % (str(GeoDist["measurement"]["distortion"]["distortion values"]["vertical mm"])))
        ReportFile.write( '\t\tCentre-of-Mass Fit:\n')
        ReportFile.write( '\t\tHorizontal CoV:     %-12s\n' % (str(GeoDist["measurement"]["distortion"]["distortion values"]["horizontal mm_CoM"])))
        ReportFile.write( '\t\tVertical CoV:       %-12s\n' % (str(GeoDist["measurement"]["distortion"]["distortion values"]["vertical mm_CoM"])))
        ReportFile.write( '\t\tRow Top (mm):       %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM horizontal distances mm"][0])))
        ReportFile.write( '\t\tRow Middle (mm):    %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM horizontal distances mm"][1])))
        ReportFile.write( '\t\tRow Bottom (mm):    %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM horizontal distances mm"][2])))
        ReportFile.write( '\t\tCol Top (mm):       %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM vertical distances mm"][0])))
        ReportFile.write( '\t\tCol Middle (mm):    %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM vertical distances mm"][1])))
        ReportFile.write( '\t\tCol Bottom (mm):    %-12s\n' % (str(GeoDist["measurement"]["distortion"]["CoM vertical distances mm"][2])))
        ReportFile.write( '\n\t\tGaussian Fit:\n')
        ReportFile.write( '\t\tHorizontal CoV:     %-12s\n' % (str(GeoDist["measurement"]["distortion"]["distortion values"]["horizontal mm"])))
        ReportFile.write( '\t\tVertical CoV:       %-12s\n' % (str(GeoDist["measurement"]["distortion"]["distortion values"]["vertical mm"])))
