...
class SliceThicknessModule(MedACRModule):
    ...
    def Run(self):
        ...
        acr_slice_thickness_task = ACRSliceThickness(input_data=Data,report_dir=OutputPath,report=True,MediumACRPhantom=True,Paramater_overide = ParamaterOverides, UseLegacySliceThicknessAlgo=UseLegacySliceThicknessAlgo,settings=self.settings)
